...
Challenge!
See if you can write this function with only one loop, i.e., only a single for or while. Hint: Look at https://docs.python.org/3/library/functions.html for a function that will help. 